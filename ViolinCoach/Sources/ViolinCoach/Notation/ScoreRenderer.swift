...
public enum ScoreRenderer {
    ...
    ///
    /// Row granularity is the whole point: the score should sit still while
    /// you play through a system and move only at the line break, so the
    /// notation under your eyes never shifts mid-phrase.
